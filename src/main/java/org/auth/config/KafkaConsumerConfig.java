...
import org.auth.deserializer.UserInfoDeserializer;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, UserInfoDto> consumerFactory() {
        ...
        props.put(org.apache.kafka.clients.consumer.ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, UserInfoDeserializer.class);
